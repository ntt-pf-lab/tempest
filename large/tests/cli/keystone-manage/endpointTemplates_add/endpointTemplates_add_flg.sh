...
endpoint_enabled=0
endpoint_is_global=0

RESULT=`${KEYSTONE_PATH} ${CMD} ${endpoint_region} ${service_name} ${endpoint_public_url} ${endpoint_admin_url} ${endpoint_internal_url} ${endpoint_enabled} ${endpoint_is_global}`
echo $? > ${PWD}${FILE_NAME}
