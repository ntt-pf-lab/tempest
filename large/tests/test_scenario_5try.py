...
L2_NETWORK = ('10.1.5.0/24', 'br-int', '10.1.5.1', '10.1.5.2') 
# Outer L2 network, bridge, gateway, dhcp
G2_NETWORK = ('172.30.5.0/24', 'br-int', '172.30.5.1', '172.30.5.2')
...
class ScenarioTest(FunctionalTest):
    ...
    def test_scenario_application_new_tenant(self):
        ...
        vmserver = 0
        try:
            setups = self._application_tenant("5_scenario_application")
        ...
        try:
            ...
            messages.append({'scenario':'5_scenario_application', 'result': result})
    ...
    def test_scenario_delete_tenant(self):
        ...
        vmserver = 0
        try:
            setups = self._application_tenant("5_scenario_delete")
            result['setups'] = setups
        except:
            raise
        try:
            ...
            result['servers'] = self._list_all_instance()
            self.data.teardown_all()
            messages.append({'scenario':'5_scenario_delete', 'result': result})
    ...
    def test_scenario_application_new_vpn_tenant(self):
        ...
        vmserver = 0
        try:
            setups = self._application_vpn_tenant("5_scenario_vpn_application")
            result['setups'] = setups
        except:
            raise
        try:
            ...
            self._terminate_instance(vmlb)
            self._terminate_instance(vmserver)
            messages.append({'scenario':'5_scenario_vpn_application', 'result': result})
    ...
    def test_scenario_delete_vpn_tenant(self):
        ...
        vmserver = 0
        try:
            setups = self._application_vpn_tenant("5_scenario_vpn_delete")
            result['setups'] = setups
        except:
            raise
        try:
            ...
            result['servers'] = self._list_all_instance()
            self.data.teardown_all()
            messages.append({'scenario':'5_scenario_vpn_delete', 'result': result})
    ...
    def test_scenario_scaleout(self):
        ...
        scaled = 0
        try:
            setups = self._application_tenant("5_scenario_scaleout")
            result['setups'] = setups
        except:
            raise
        try:
            ...
            messages.append({'scenario':'5_scenario_scaleout', 'result': result})
    ...
    def test_scenario_scaleout_vpn(self):
        ...
        scaled = 0
        try:
            setups = self._application_vpn_tenant("5_scenario_scaleout_vpn")
            result['setups'] = setups
        except:
            raise
        try:
            ...
            self._terminate_instance(vmserver)
            self._terminate_instance(scaled)
            messages.append({'scenario':'5_scenario_scaleout_vpn', 'result': result})
    ...
    def test_scenario_snapshot(self):
        ...
        vmserver = 0
        try:
            setups = self._application_tenant("5_scenario_snapshot")
            result['setups'] = setups
        except:
            raise
        try:
            ...
            self._terminate_instance(vmlb)
            self._terminate_instance(vmserver)
            messages.append({'scenario':'5_scenario_snapshot', 'result': result})
    ...
    def test_scenario_snapshot_vpn(self):
        ...
        vmserver = 0
        try:
            setups = self._application_vpn_tenant("5_scenario_snapshot_vpn")
            result['setups'] = setups
        except:
            raise
        try:
            ...
            self._terminate_instance(vmlb)
            self._terminate_instance(vmserver)
            messages.append({'scenario':'5_scenario_snapshot_vpn', 'result': result})
